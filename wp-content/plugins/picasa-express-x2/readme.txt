=== Plugin Name ===
Contributors: wott
Donate link: http://wott.net.ru/donate/
...
Go to my page [Garbage Collector 2.0](http://wott.net.org/picasa-express/ "Picasa Express x2 home page") and write in the comment you wishes. I will review it under next release planning. Of course if you donate me I make feature faster and take attention for your message.
...
A lot of enhacement is in. I hope so you will work easely and fast with images on your blog. The full feature list and description is in [plugin version page](http://wott.net.ru/picasa-express/new-version-1-4-of-picasa-express-plugin-for-wordpress/ "Picasa Express x2 v1.4")

Developers can add button for use plugin in form like custom_posts. For details please visit [my site](http://wott.net.ru/picasa-express/new-version-1-4-of-picasa-express-plugin-for-wordpress/ "Picasa Express x2 v1.4")
